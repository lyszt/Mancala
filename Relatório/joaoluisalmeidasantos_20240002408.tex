...
Vale mencionar que em vários pontos, eu coloquei esses textos dentro de rótulos no .text, onde poderiam ser acessados pela função \text{print} para printar valores como se fosse em um for loop. Isso me permitiu diminuir o tamanho do arquivo.
